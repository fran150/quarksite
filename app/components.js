        ...
        .namespace('docs')
            ...
            .namespace('refs')
                ...
                .namespace('routing')
                    ...
                    .register('controllersbase', 'pages/docs/refs/routing/controllersbase')
                    .register('current', 'pages/docs/refs/routing/current')
                    .register('routed', 'pages/docs/refs/routing/routed')
                    .register('pages', 'pages/docs/refs/routing/pages')
                    .register('maproute', 'pages/docs/refs/routing/maproute')
                    .register('parse', 'pages/docs/refs/routing/parse')
                    .register('hash', 'pages/docs/refs/routing/hash')
                    .register('activatehasher', 'pages/docs/refs/routing/activatehasher')
